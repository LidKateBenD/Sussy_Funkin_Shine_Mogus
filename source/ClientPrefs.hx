...
class ClientPrefs {
	...
	public static var gameHUD:String = 'Psych';
	public static var scoreZoom:Bool = true;
	public static var noReset:Bool = false;
	public static var beansNum:Float = 0;
	...
	public static var machinedifficulty:String = 'classic';
	...
	public static function saveSettings() {
		FlxG.save.data.machinedifficulty = machinedifficulty;
	...
	public static function loadPrefs() {
		if(FlxG.save.data.machinedifficulty != null) {
		machinedifficulty = FlxG.save.data.machinedifficulty;
		}
